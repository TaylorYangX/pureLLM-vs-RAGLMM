        ...
        for mode, metrics in modes.items():
            for metric_name, stats in metrics.items():
                rows.append({
                    ...
                    "mode": mode,
                    "mode_display": "Baseline" if mode == "baseline" else "RAG-Augmented",
                    "metric": metric_name,
...
def plot_lexical_comparison(
    ...
    for idx, metric in enumerate(lexical_metrics):
        ...
        ax.set_xticks(x)
        ax.set_xticklabels(
            [MODEL_DISPLAY_NAMES.get(m, m) for m in model_keys],
            fontsize=9
        )
...
def plot_semantic_comparison(
    ...
    # 语义指标
    semantic_metrics = ["bert_precision", "bert_recall", "bert_f1"]
...
def plot_improvement_heatmap(
    ...
    model_keys = list(results.keys())
    all_metrics = ["bleu", "rouge1", "rouge2", "rougeL",
...
def plot_cross_model_comparison(
    ...
    for c_idx, (baseline_key, rag_key, label) in enumerate(comparisons):
        ...
        baseline_means = [
            results[baseline_key]["baseline"][m]["mean"]
            for m in all_metrics
        ]
        rag_means = [
            results[rag_key]["rag"][m]["mean"]
            for m in all_metrics
        ]
        ...
        rag_errors = [
            results[rag_key]["rag"][m].get("margin_of_error", 0)
            for m in all_metrics
        ]
...
def plot_all_metrics_overview(
    ...
    for m_idx, model_key in enumerate(model_keys):
        ...
        baseline_means = [
            results[model_key]["baseline"][metric]["mean"]
            for metric in all_metrics
        ]
        rag_means = [
            results[model_key]["rag"][metric]["mean"]
            for metric in all_metrics
        ]
        ...
        ax.bar(
            x + offset_base, baseline_means, single_width,
        ...
        ax.bar(
            x + offset_rag, rag_means, single_width,
...
def generate_all_plots(results: dict, figure_dir: str = "figures"):
    ...
    plot_lexical_comparison(
        results,
        save_path=os.path.join(figure_dir, "fig3_lexical_comparison.png")
    )
    ...
    plot_semantic_comparison(
        results,
        save_path=os.path.join(figure_dir, "fig4_semantic_comparison.png")
    )
    ...
    plot_improvement_heatmap(
        results,
        save_path=os.path.join(figure_dir, "table3_improvement_heatmap.png")
    )
    ...
    plot_cross_model_comparison(
        results,
        save_path=os.path.join(figure_dir, "fig5_cross_model_comparison.png")
    )
    ...
    plot_all_metrics_overview(
        results,
        save_path=os.path.join(figure_dir, "all_metrics_overview.png")
    )
...
if __name__ == "__main__":
    ...
    mock_results = {
        "tinyllama": {
            "baseline": {
                "bleu": {"mean": 0.025, "ci_lower": 0.020, "ci_upper": 0.030, "margin_of_error": 0.005},
                "rouge1": {"mean": 0.15, "ci_lower": 0.13, "ci_upper": 0.17, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.06, "ci_lower": 0.05, "ci_upper": 0.07, "margin_of_error": 0.01},
                "rougeL": {"mean": 0.12, "ci_lower": 0.10, "ci_upper": 0.14, "margin_of_error": 0.02},
                "bert_precision": {"mean": 0.83, "ci_lower": 0.82, "ci_upper": 0.84, "margin_of_error": 0.01},
                "bert_recall": {"mean": 0.86, "ci_lower": 0.85, "ci_upper": 0.87, "margin_of_error": 0.01},
                "bert_f1": {"mean": 0.845, "ci_lower": 0.84, "ci_upper": 0.85, "margin_of_error": 0.005},
            },
            "rag": {
                "bleu": {"mean": 0.032, "ci_lower": 0.028, "ci_upper": 0.036, "margin_of_error": 0.004},
                "rouge1": {"mean": 0.20, "ci_lower": 0.18, "ci_upper": 0.22, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.085, "ci_lower": 0.07, "ci_upper": 0.10, "margin_of_error": 0.015},
                "rougeL": {"mean": 0.157, "ci_lower": 0.14, "ci_upper": 0.17, "margin_of_error": 0.015},
                "bert_precision": {"mean": 0.845, "ci_lower": 0.84, "ci_upper": 0.85, "margin_of_error": 0.005},
                "bert_recall": {"mean": 0.88, "ci_lower": 0.87, "ci_upper": 0.89, "margin_of_error": 0.01},
                "bert_f1": {"mean": 0.86, "ci_lower": 0.85, "ci_upper": 0.87, "margin_of_error": 0.01},
            },
        },
        "mistral": {
            "baseline": {
                "bleu": {"mean": 0.04, "ci_lower": 0.035, "ci_upper": 0.045, "margin_of_error": 0.005},
                "rouge1": {"mean": 0.22, "ci_lower": 0.20, "ci_upper": 0.24, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.095, "ci_lower": 0.08, "ci_upper": 0.11, "margin_of_error": 0.015},
                "rougeL": {"mean": 0.1775, "ci_lower": 0.16, "ci_upper": 0.195, "margin_of_error": 0.0175},
                "bert_precision": {"mean": 0.84, "ci_lower": 0.83, "ci_upper": 0.85, "margin_of_error": 0.01},
                "bert_recall": {"mean": 0.87, "ci_lower": 0.86, "ci_upper": 0.88, "margin_of_error": 0.01},
                "bert_f1": {"mean": 0.855, "ci_lower": 0.85, "ci_upper": 0.86, "margin_of_error": 0.005},
            },
            "rag": {
                "bleu": {"mean": 0.064, "ci_lower": 0.058, "ci_upper": 0.070, "margin_of_error": 0.006},
                "rouge1": {"mean": 0.28, "ci_lower": 0.26, "ci_upper": 0.30, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.122, "ci_lower": 0.11, "ci_upper": 0.134, "margin_of_error": 0.012},
                "rougeL": {"mean": 0.227, "ci_lower": 0.21, "ci_upper": 0.244, "margin_of_error": 0.017},
                "bert_precision": {"mean": 0.858, "ci_lower": 0.85, "ci_upper": 0.866, "margin_of_error": 0.008},
                "bert_recall": {"mean": 0.895, "ci_lower": 0.89, "ci_upper": 0.90, "margin_of_error": 0.005},
                "bert_f1": {"mean": 0.876, "ci_lower": 0.87, "ci_upper": 0.882, "margin_of_error": 0.006},
            },
        },
        "llama3.1": {
            "baseline": {
                "bleu": {"mean": 0.008, "ci_lower": 0.005, "ci_upper": 0.011, "margin_of_error": 0.003},
                "rouge1": {"mean": 0.05, "ci_lower": 0.04, "ci_upper": 0.06, "margin_of_error": 0.01},
                "rouge2": {"mean": 0.023, "ci_lower": 0.018, "ci_upper": 0.028, "margin_of_error": 0.005},
                "rougeL": {"mean": 0.044, "ci_lower": 0.035, "ci_upper": 0.053, "margin_of_error": 0.009},
                "bert_precision": {"mean": 0.77, "ci_lower": 0.76, "ci_upper": 0.78, "margin_of_error": 0.01},
                "bert_recall": {"mean": 0.87, "ci_lower": 0.86, "ci_upper": 0.88, "margin_of_error": 0.01},
                "bert_f1": {"mean": 0.82, "ci_lower": 0.81, "ci_upper": 0.83, "margin_of_error": 0.01},
            },
            "rag": {
                "bleu": {"mean": 0.026, "ci_lower": 0.022, "ci_upper": 0.030, "margin_of_error": 0.004},
                "rouge1": {"mean": 0.14, "ci_lower": 0.12, "ci_upper": 0.16, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.058, "ci_lower": 0.048, "ci_upper": 0.068, "margin_of_error": 0.01},
                "rougeL": {"mean": 0.108, "ci_lower": 0.09, "ci_upper": 0.126, "margin_of_error": 0.018},
                "bert_precision": {"mean": 0.81, "ci_lower": 0.80, "ci_upper": 0.82, "margin_of_error": 0.01},
                "bert_recall": {"mean": 0.886, "ci_lower": 0.88, "ci_upper": 0.892, "margin_of_error": 0.006},
                "bert_f1": {"mean": 0.83, "ci_lower": 0.82, "ci_upper": 0.84, "margin_of_error": 0.01},
            },
        },
        "llama1-13b": {
            "baseline": {
                "bleu": {"mean": 0.035, "ci_lower": 0.030, "ci_upper": 0.040, "margin_of_error": 0.005},
                "rouge1": {"mean": 0.20, "ci_lower": 0.18, "ci_upper": 0.22, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.088, "ci_lower": 0.075, "ci_upper": 0.101, "margin_of_error": 0.013},
                "rougeL": {"mean": 0.165, "ci_lower": 0.15, "ci_upper": 0.18, "margin_of_error": 0.015},
                "bert_precision": {"mean": 0.83, "ci_lower": 0.82, "ci_upper": 0.84, "margin_of_error": 0.01},
                "bert_recall": {"mean": 0.875, "ci_lower": 0.87, "ci_upper": 0.88, "margin_of_error": 0.005},
                "bert_f1": {"mean": 0.852, "ci_lower": 0.85, "ci_upper": 0.854, "margin_of_error": 0.002},
            },
            "rag": {
                "bleu": {"mean": 0.063, "ci_lower": 0.057, "ci_upper": 0.069, "margin_of_error": 0.006},
                "rouge1": {"mean": 0.26, "ci_lower": 0.24, "ci_upper": 0.28, "margin_of_error": 0.02},
                "rouge2": {"mean": 0.115, "ci_lower": 0.10, "ci_upper": 0.13, "margin_of_error": 0.015},
                "rougeL": {"mean": 0.195, "ci_lower": 0.18, "ci_upper": 0.21, "margin_of_error": 0.015},
                "bert_precision": {"mean": 0.845, "ci_lower": 0.84, "ci_upper": 0.85, "margin_of_error": 0.005},
                "bert_recall": {"mean": 0.881, "ci_lower": 0.877, "ci_upper": 0.885, "margin_of_error": 0.004},
                "bert_f1": {"mean": 0.856, "ci_lower": 0.853, "ci_upper": 0.859, "margin_of_error": 0.003},
            },
        },
    }
